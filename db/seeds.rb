...
Customer.create([
    {name: "Herr Brown", address: "Ratoldstr. 215", delivery_note: "BK1", district_id: District.first.id},
    {name: "Herr Black", address: "Ratoldstr. 215", delivery_note: "BK2", district_id: District.first.id},
    {name: "Frau Pink", address: "Ratoldstr. 215", delivery_note: "BK 5/1", district_id: District.second.id},
    {name: "Herr Green", address: "Ratoldstr. 215", delivery_note: "BK 3/2", district_id: District.second.id},
    {name: "Herr Red", address: "Ratoldstr. 215", delivery_note: "RO", district_id: District.last.id},
    {name: "Frau Violet", address: "Ratoldstr. 215", delivery_note: "RO", district_id: District.last.id}
  ])
